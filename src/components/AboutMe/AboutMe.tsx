    ...
    <section id="about-me" className="about-me">
      ...
      <div className="about-me__container">
        ...
        <p className="about-me__text">
          ...
          информацию из всевозможных источников, большой интерес вызывают вебинары и видео на ютубе с лайвкодингом, где
          можно подчерпнуть что-нибудь новое и интересное.
        </p>
